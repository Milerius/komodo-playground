...
namespace komodo::tests
{
    ...
    {
        executor exc(parse_cfg());
        CHECK(exc.decodetransaction({"decodetransaction", "8cedbf6529611704df32cea570974a1ca83027ee75f109f424fef4aa0e8e391d"}));
        CHECK_FALSE(exc.decodetransaction({"decodetransaction", "fake"}));
    }
}